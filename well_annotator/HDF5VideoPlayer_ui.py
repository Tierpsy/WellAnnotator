...
class Ui_HDF5VideoPlayer(object):
    def setupUi(self, HDF5VideoPlayer):
        ...
        HDF5VideoPlayer.resize(1200, 760)
        ...
        self.outerLayout.setContentsMargins(11, 11, 11, 11)
        self.outerLayout.setSpacing(6)
        ...
        self.verticalLayout_2.setObjectName("verticalLayout_right")
        ...
        self.outerLayout.addLayout(self.verticalLayout)
        self.outerLayout.addLayout(self.verticalLayout_2)
        self.outerLayout.setStretch(0, 3)
